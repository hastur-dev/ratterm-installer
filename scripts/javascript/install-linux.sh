#!/usr/bin/env bash
# Install script for JavaScript (Node.js) on Linux
...
install_nodejs() {
    ...
    log_info "Installing Node.js (JavaScript runtime) using ${package_manager}..."
...
# Main entry point
main() {
    log_info "Starting JavaScript (Node.js) installation on Linux..."
